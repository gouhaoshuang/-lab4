...
main: 
	...
	addi $7, $3,-9 		# initialize $7=3 		8  2067fff7  //存在数据冒险
	or $4, $7, $2 		# $4 <= 3 or 5 = 7 		c  00e22025  //存在数据冒险
	and $5, $3, $4 		# $5 <= 12 and 7 = 4 	10 00642824  
	add $5, $5, $4 		# $5 = 4 + 7 = 11 		14 00a42820  
	beq $5, $7, end 	# shouldn't be taken 	18 10a7000c  .. $5 = 11  $7=3  
...
around: 
	...
	add $7, $4, $5 		# $7 = 1 + 11 = 12 		30 00853820  //存在数据冒险
	sub $7, $7, $2 		# $7 = 12 - 5 = 7 		34 00e23822  //存在数据冒险
